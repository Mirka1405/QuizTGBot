...
if __name__ == "__main__":
    form_data = {
        ...
        'contacts': 'Для более детальных рекомендаций напишите запрос в телеграм @telegram или на е-мейл ira@example.org',
        'link': 'example.org',
        'date': '19.09.2025',
        'amnt': '12'
    }
    with open("test.pdf","wb") as f:
        b = replace_placeholders_htmlbox('pdf_template.pdf', form_data, "montserrat.ttf")
        b.seek(0)
        f.write(b.read())
